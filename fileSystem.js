...
function getAllFilePathsWithExtension(directoryPath, extension, filePaths) {
    ...
    for (const fileName of fileNames) {
        // TODO WinDev; olo; Убедиться, что будет работать под Windows.
...
function readFile(filePath) {
    ...
    return {content: fs.readFileSync(filePath, 'utf8'), filename: filename}; // TODO Veronika; 2018-08-16; сделать кодировку настраиваемой
}
